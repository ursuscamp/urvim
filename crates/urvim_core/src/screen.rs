...
use urvim_terminal::{Style, Terminal};
...
mod tests {
    ...
    fn test_clear_with_style() {
        let mut screen = Screen::new(2, 2);
        let style = Style::new().bold().fg(urvim_terminal::Color::ansi(196));
    ...
    fn test_fill_region() {
        let mut screen = Screen::new(3, 3);
        let style = Style::new().bg(urvim_terminal::Color::ansi(30));
    ...
    fn test_overlay_region_preserves_text() {
        let mut screen = Screen::new(2, 2);
        let style = Style::new().bg(urvim_terminal::Color::ansi(30));
        screen.write_string(0, 0, Style::new().fg(urvim_terminal::Color::ansi(5)), "a");
        ...
        assert_eq!(
            cell.style,
            Style::new()
                .fg(urvim_terminal::Color::ansi(5))
                .bg(urvim_terminal::Color::ansi(30))
        );
    }
