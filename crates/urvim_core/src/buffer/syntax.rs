//! Syntax highlighting cache primitives.
...
use urvim_syntax::SyntaxDefinition;
use urvim_syntax::state::{
    SyntaxFoldEvent, SyntaxFoldEventKind, SyntaxFoldKind, SyntaxLineResult, SyntaxState,
    syntax_definition, tokenize_line_definition,
};

pub use urvim_syntax::state::SyntaxSpan;
...
mod tests {
    ...
    use urvim_syntax::state::{ContextId, ContextStack};
    use urvim_theme::Tag;
