...
const CORPORA: [Corpus; 6] = [
    Corpus {
        name: "rust",
        ext: "rs",
        source: include_str!("../../urvim_syntax/fixtures/rust.rs"),
        dirty_needle: "Option",
    ...
    Corpus {
        name: "javascript",
        ext: "js",
        source: include_str!("../../urvim_syntax/fixtures/javascript.js"),
        dirty_needle: "fetch",
    ...
    Corpus {
        name: "markdown",
        ext: "md",
        source: include_str!("../../urvim_syntax/fixtures/markdown.md"),
    ...
    Corpus {
        name: "html",
        ext: "html",
        source: include_str!("../../urvim_syntax/fixtures/html.html"),
    ...
    Corpus {
        name: "bash",
        ext: "sh",
        source: include_str!("../../urvim_syntax/fixtures/bash.sh"),
...
fn prepare_dirty_buffer(corpus: Corpus, scenario: Scenario) -> Buffer {
    ...
    if let Some(line_text) = buffer.line_at(dirty_line) {
        ...
        if let Some(start) = text.find(corpus.dirty_needle) {
            ...
            buffer.remove(
                urvim_core::buffer::Cursor::new(dirty_line, start),
                urvim_core::buffer::Cursor::new(dirty_line, end),
            );
            buffer.insert_text(
                urvim_core::buffer::Cursor::new(dirty_line, start),
