use crate::json_rpc::codec::{JsonRpcError, decode_message, encode_message};
use crate::json_rpc::transport::JsonRpcTransport;
use crate::json_rpc::types::{Message, Notification, Request, RequestId};
...
mod tests {
    use super::*;
    use crate::json_rpc::transport::MemoryTransport;
    use serde_json::json;
